package br.com.helpIT.project.carregamento.lazy;
...
import br.com.helpIT.framework.controller.crud.Controller;
...
public class CarregamentoLazyListForObject<T> extends LazyDataModel<T> {
	...
	private Controller controller = (Controller) ContextLoaderListenerHelpITUtils.getBean(Controller.class);	
