package br.com.helpIT.project.filter;
...
import br.com.helpIT.listener.ContextLoaderListenerHelpITUtils;
import br.com.helpIT.model.classes.Entidade;
import br.com.helpIT.utils.UtilFramework;
...
public class FilterOpenSessionInView extends DelegatingFilterProxy implements Serializable {
	...
	// executado quando a aplicacao está sendo iniciada		
	@Override
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		// JDBC Spring
		BasicDataSource springDataSource = (BasicDataSource) ContextLoaderListenerHelpITUtils.getBean("springDataSource");
